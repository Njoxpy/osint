That's awesome that you're studying OSINT! It's a fascinating field, and a great fit for the analytical mind of an INTJ. JAJAAJAA!
...
3.  All from **publicly available sources**.
4.  To create **actionable intelligence** that helps answer a specific question or solve a problem.
...
That's an excellent follow-up question in the context of OSINT!

In Open-Source Intelligence (OSINT), a **"sock puppet"** (or "sock puppet account") is a fictitious online identity created and managed by an investigator to conceal their true identity while conducting research.

The term comes from the idea of a hand puppet made from a sock—it looks like a different character, but someone else is controlling all its actions.

### The Purpose of a Sock Puppet in OSINT

The primary reason for using a sock puppet is for **Operational Security (OPSEC)** and **Data Collection**:

1.  **Anonymity/OPSEC:** It separates the investigator's real identity, location, and professional life from the investigation. You never want a target to trace your research back to your real name or organization.
2.  **Accessing Restricted Content:** Many social media platforms and forums restrict content to registered users or "friends." A sock puppet allows the investigator to create an account and access this content passively.
3.  **Active Engagement:** In some forms of investigation (like social engineering), a believable sock puppet is used to interact with a target or a community to gather more detailed, "human intelligence" (HUMINT) that wouldn't be public.

### How a Believable Sock Puppet is Created
...
That's exactly right, but with a critical distinction in the context of Open-Source Intelligence (OSINT).

A sock puppet **is a fake account**, but the term emphasizes the level of **planning, maintenance, and technical security** used to make it completely disconnected from the investigator's real identity.
